...
public class MainView {// extends View {
   ...
   public final int numCellTypes = 21;                //方块种类数量，也是数字阶级数量，0~ 2^20

   /*  private static final String TAG = MainView.class.getSimpleName();
    private static final float MERGING_ACCELLRATIONG = (float) -0.5;
    private static final float INITIAL_VELOCITY = (1-MERGING_ACCELLRATIONG) / 4;
